...
//                   whileTap={{ scale: 0.98 }}
//                   className="w-full bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 text-white py-4 px-6 rounded-lg font-medium hover:shadow-lg transition-all duration-300"
//                 >
//                   Proceed to Checkout
//                 </motion.button>
//               </div>
